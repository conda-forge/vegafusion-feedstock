...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/vegafusion-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15626&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vegafusion-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vegafusion` can be installed with:

```
conda install vegafusion
```

It is possible to list all of the versions of `vegafusion` available on your platform with:
